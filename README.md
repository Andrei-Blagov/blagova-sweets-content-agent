...
AI-агент для генерации готовых постов социальных сетей пекарни **BLAGOVA_SWEETS** на основе URL страницы или вручную переданного текста.
...
Учебно-практический проект для вайб-кодинга с Cursor и рабочий внутренний инструмент контента пекарни BLAGOVA_SWEETS.
